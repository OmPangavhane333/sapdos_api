...
//   void initState() {
//     super.initState();
//     _futureData = fetchDoctorsFromApi();
//   }

//   Future<Map<String, dynamic>> fetchDoctorsFromApi() async {
//     const apiUrl =
//         'https://sapdos-api-v2.azurewebsites.net/api/Patient/GetDoctorByUId';
...
//         List<Doctor> doctors = doctorListJson.map((json) => Doctor(
//           name: json['doctorName'] ?? 'Unknown Doctor',
//           specialization: json['specialization'] ?? 'Unknown Specialization',
//           rating: 0.0,
//           doctorImage: json['doctorImage'] ?? '',
